...
func GoVideoList(videoList []model.Video) error {
	...
	for _, video := range videoList {
		...
		pipe.HSet(global.CONTEXT, keyVideo, "title", video.Title)
		pipe.HSet(global.CONTEXT, keyVideo, "play_name", video.PlayName)
		pipe.HSet(global.CONTEXT, keyVideo, "cover_name", video.CoverName)
		pipe.HSet(global.CONTEXT, keyVideo, "favorite_count", video.FavoriteCount)
		pipe.HSet(global.CONTEXT, keyVideo, "comment_count", video.CommentCount)
		pipe.HSet(global.CONTEXT, keyVideo, "author_id", video.AuthorID)
		pipe.HSet(global.CONTEXT, keyVideo, "created_at", video.CreatedAt.UnixMilli())
